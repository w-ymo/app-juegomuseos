...
public class WorldMapArea {
    ...
    public final void initUI() throws Exception {
        ...
        //recupera URL de la imagen
        URL url = new URL("https://i.stack.imgur.com/N4eOn.png");
        //decode la URL y pasa a BufferedImage
    ...
    //metodo que devuelve el area pasando como parametro al color que quieres apuntar, la imagen y la tolerancia
    public Area getOutline(Color targetColor, BufferedImage buffImg, int tolerance) {
        //clase que construye un camino a partir de líneas
        GeneralPath gp = new GeneralPath();

        boolean cont = false;
        for (int xx = 0; xx < buffImg.getWidth(); xx++) {
            for (int yy = 0; yy < buffImg.getHeight(); yy++) {
                if (isIncluded(new Color(buffImg.getRGB(xx, yy)), targetColor, tolerance)) {
